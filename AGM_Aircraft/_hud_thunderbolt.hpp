  ...
  class HUD_2
  {
    ...
    class Draw
    {
      ...
      */
      ...
      class PlaneMovementCrosshair //fwd
      {
        clipTL[]={0,1};
        clipBR[]={1,0};
        type="line";
