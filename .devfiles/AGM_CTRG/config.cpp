...
New classes:
    ...
    CfgVehicles
  AGM_U_CTRG_Security_Contractor_F
  AGM_U_CTRG_Security_Contractor_lite_F
  AGM_U_CTRG_Squad_Coordinator_F
  AGM_U_CTRG_Team_Coordinator_F
  AGM_U_CTRG_Tactical_Specialist_AR_F
  AGM_U_CTRG_Field_Medic_F
  AGM_U_CTRG_Field_Technician_F
  AGM_U_CTRG_Field_Specialist_exp_F
  AGM_U_CTRG_Security_Contractor_GL_F
  AGM_U_CTRG_Defensive_Marksman_F
  AGM_U_CTRG_Field_Specialist_AT_F
  AGM_U_CTRG_Tactical_Driver
  AGM_U_CTRG_Tactical_Pilot

  AGM_U_CTRG_SUV_01_F
  AGM_U_CTRG_Quadbike_01_F
  AGM_U_CTRG_Heli_Light_01_F
  AGM_U_CTRG_Boat_Transport_01_F
...
class CfgFactionClasses {
  class AGM_U_CTRG_F {
    ...
    displayName = "$STR_AGM_CTRG_Faction";
    priority = 3;
    side = 2;
  };
};
...
class CfgVehicles {
  ...
  class AGM_U_CTRG_Security_Contractor_base_F: SoldierGB {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Security_Contractor_base_F";
    expansion = 1;
    identityTypes[] = {"LanguageENG_F", "Head_NATO", "G_NATO_default"};
    faceType = "Man_A3";
    side = 2;
    faction = "AGM_U_CTRG_F";
  ...
  class AGM_U_CTRG_Security_Contractor_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Security_Contractor_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Security_Contractor";
  };

  class AGM_U_CTRG_Security_Contractor_lite_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "I_Soldier_lite_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Security_Contractor_lite";
    cost = 90000;
    camouflage = 1.2;
  ...
  class AGM_U_CTRG_Squad_Coordinator_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Squad_Coordinator_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Squad_Coordinator";
    cost = 500000;
    camouflage = 1.6;
    sensitivity = 3.2;
    icon = "iconManLeader";
  ...
  class AGM_U_CTRG_Team_Coordinator_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Team_Coordinator_F";
    scope = 2;
    scopeCurator = 2;
    cost = 450000;
    sensitivity = 3.2;
    threat[] = {1,0.3,0.1};
    icon = "iconManLeader";
    displayName = "$STR_AGM_CTRG_Team_Coordinator";
  ...
  class AGM_U_CTRG_Tactical_Specialist_AR_F: AGM_U_CTRG_Security_Contractor_base_F {
    ...
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Tactical_Specialist_AR_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Tactical_Specialist_AR";
  ...
  class AGM_U_CTRG_Field_Medic_F: AGM_U_CTRG_Security_Contractor_base_F {
    class SpeechVariants {
      class Default {
    ...
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Field_Medic_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Field_Medic";
  ...
  class AGM_U_CTRG_Field_Technician_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Field_Technician_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Field_Technician";
  ...
  class AGM_U_CTRG_Field_Specialist_exp_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "I_Soldier_exp_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Field_Specialist_exp";
    cost = 115000;
    camouflage = 1.6;
    sensitivity = 2.8;
  ...
  class AGM_U_CTRG_Security_Contractor_GL_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Security_Contractor_GL_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Security_Contractor_GL";
  ...
  class AGM_U_CTRG_Defensive_Marksman_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Defensive_Marksman_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Defensive_Marksman";
  ...
  class AGM_U_CTRG_Field_Specialist_AT_F: AGM_U_CTRG_Security_Contractor_base_F {
    class SpeechVariants {
      class Default {
    ...
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Field_Specialist_AT_F";
    scope = 2;
    scopeCurator = 2;
    displayName = "$STR_AGM_CTRG_Field_Specialist_AT";
  ...
  class AGM_U_CTRG_Soldier_A_F: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Soldier_A_F";
    scope = 0;
    scopeCurator = 0;
    displayName = "$STR_AGM_CTRG_Soldier_ammo";
    cost = 50000;
  ...
  class AGM_U_CTRG_officer_F: AGM_U_CTRG_Security_Contractor_base_F {
    class SpeechVariants {
      class Default {
    ...
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_officer_F";
    ...
    scope = 0;
    scopeCurator = 0;
    displayName = "$STR_AGM_CTRG_Soldier_Officer";
  ...
  class AGM_U_CTRG_Tactical_Driver: AGM_U_CTRG_Security_Contractor_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Tactical_Driver";
    class UniformInfo {
      class SlotsInfo {
    ...
    scope = 2;
    displayName = "$STR_AGM_CTRG_Tactical_Driver";
  ...
  class AGM_U_CTRG_Tactical_Pilot: AGM_U_CTRG_Security_Contractor_base_F {
    class SpeechVariants {
      class Default {
    ...
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Tactical_Pilot";
    scope = 2;
    displayName = "$STR_AGM_CTRG_Tactical_Pilot";
    weapons[] = {"arifle_MXC_black_F","hgun_Pistol_heavy_01_MRD_F","Throw","Put"};
    respawnWeapons[] = {"arifle_MXC_black_F","hgun_Pistol_heavy_01_MRD_F","Throw","Put"};
    magazines[] = {"30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","HandGrenade","HandGrenade","SmokeShell","SmokeShellBlue","Chemlight_blue","Chemlight_blue"};
    respawnMagazines[] = {"30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","HandGrenade","HandGrenade","SmokeShell","SmokeShellBlue","Chemlight_blue","Chemlight_blue"};
  ...
  class SUV_01_base_F;
  class AGM_U_CTRG_SUV_01_F: SUV_01_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_SUV_01_F";
    scope = 2;
    crew = "AGM_U_CTRG_Tactical_Driver";
    typicalCargo[] = {"AGM_U_CTRG_Security_Contractor_F"};
    side = 2;
    displayName = "$STR_AGM_CTRG_Vehicle_SUV";
    faction = "AGM_U_CTRG_F";
    accuracy = 1.25;
  ...
  class AGM_U_CTRG_Quadbike_01_F: Quadbike_01_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Quadbike_01_F";
    scope = 2;
    side = 2;
    faction = "AGM_U_CTRG_F";
    crew = "AGM_U_CTRG_Tactical_Driver";
  ...
  class AGM_U_CTRG_Heli_Light_01_F: B_Heli_Light_01_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Heli_Light_01_F";
    scope = 2;
    accuracy = 1;
    side = 2;
    faction = "AGM_U_CTRG_F";
    crew = "AGM_U_CTRG_Tactical_Pilot";
  ...
  class AGM_U_CTRG_Boat_Transport_01_F: Rubber_duck_base_F {
    author = "$STR_A3_Bohemia_Interactive";
    _generalMacro = "AGM_U_CTRG_Boat_Transport_01_F";
    scope = 2;
    crew = "AGM_U_CTRG_Tactical_Driver";
    faction = "AGM_U_CTRG_F";
    side = 2;
    typicalCargo[] = {"AGM_U_CTRG_Security_Contractor_F","AGM_U_CTRG_Security_Contractor_F"};
  };
};
...
class CfgGroups {
  class Indep {
    class AGM_PMC {
      name = "$STR_AGM_CTRG_Groups";
      class Infantry {
        name = "$STR_AGM_CTRG_Infantry";
        class AGM_PMC_InfSquad {
          name = "$STR_AGM_CTRG_InfSquad";
          side = 2;
          faction = "AGM_U_CTRG_F";
          class Unit0 {
            side = 2;
            vehicle = "AGM_U_CTRG_Squad_Coordinator_F";
            rank = "SERGEANT";
            position[] = {0,0,0};
          };
          class Unit1 {
            side = 2;
            vehicle = "AGM_U_CTRG_Team_Coordinator_F";
            rank = "SERGEANT";
            position[] = {5,-5,0};
          };
          class Unit2 {
            side = 2;
            vehicle = "AGM_U_CTRG_Tactical_Specialist_AR_F";
            rank = "CORPORAL";
            position[] = {-5,-5,0};
          };
          class Unit3 {
            side = 2;
            vehicle = "AGM_U_CTRG_Security_Contractor_GL_F";
            rank = "PRIVATE";
            position[] = {10,-10,0};
          };
          class Unit4 {
            side = 2;
            vehicle = "AGM_U_CTRG_Security_Contractor_F";
            rank = "PRIVATE";
            position[] = {-10,-10,0};
          };
          class Unit5 {
            side = 2;
            vehicle = "AGM_U_CTRG_Field_Medic_F";
            rank = "CORPORAL";
            position[] = {15,-15,0};
          };
          class Unit6 {
        ...
        class AGM_PMC_InfSquad_Weapons {
          name = "$STR_AGM_CTRG_InfSquad_Weapons";
          side = 2;
          faction = "AGM_U_CTRG_F";
          class Unit0 {
            side = 2;
          ...
          class Unit1 {
            side = 2;
            vehicle = "AGM_U_CTRG_Defensive_Marksman_F";
            rank = "SERGEANT";
            position[] = {5,-5,0};
          };
          class Unit2 {
          ...
          class Unit4 {
            side = 2;
            vehicle = "AGM_U_CTRG_Field_Specialist_AT_F";
            rank = "CORPORAL";
            position[] = {-10,-10,0};
          };
          class Unit6 {
      ...
      class Support {
        name = "$STR_AGM_CTRG_Support";
        class AGM_PMC_Support_CLS {
          name = "$STR_AGM_CTRG_Support_CLS";
          side = 2;
          faction = "AGM_U_CTRG_F";
          class Unit0 {
            side = 2;
        ...
        class AGM_PMC_Support_EOD {
          ...
          class Unit1 {
            side = 2;
            vehicle = "AGM_U_CTRG_Field_Specialist_exp_F";
            rank = "CORPORAL";
            position[] = {5,-5,0};
          };
          class Unit2 {
        ...
        class AGM_PMC_Support_ENG {
          ...
          class Unit2 {
            side = 2;
            vehicle = "AGM_U_CTRG_Field_Technician_F";
            rank = "PRIVATE";
            position[] = {-5,-5,0};
          };
          class Unit3 {
      ...
      class Motorized_MTP {
        name = "$STR_AGM_CTRG_Motorized_MTP";
        class IRG_MotInf_Team {
          name = "$STR_AGM_CTRG_Motorized_MTP_MotInfTeam";
          side = 2;
          faction = "AGM_U_CTRG_F";
          class Unit0 {
            side = 2;
            vehicle = "AGM_U_CTRG_SUV_01_F";
            rank = "SERGEANT";
            position[] = {0,0,0};
          };
          class Unit1 {
          ...
          class Unit3 {
            side = 2;
            vehicle = "AGM_U_CTRG_Security_Contractor_F"; //"AGM_U_CTRG_Field_Specialist_AT_F";
            rank = "CORPORAL";
            position[] = {25,-25,2};
          };
          /*class Unit4 {
