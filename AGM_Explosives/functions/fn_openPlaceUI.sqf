...
_listIDC = [localize "STR_AGM_Explosives_PlaceMenu", localize "STR_AGM_Explosives_Place", "closeDialog 0;private ['_mag'];_mag=lbData [8866, lbCurSel 8866];[_mag] call AGM_Explosives_fnc_openTriggerSelectionUI;"] call AGM_Interaction_fnc_openSelectMenu;
