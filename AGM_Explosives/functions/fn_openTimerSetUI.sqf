...
buttonSetAction [8860, format["[player, '%1', configFile >> 'CfgAGM_Triggers' >> 'Timer', floor(sliderPosition 8845)] call AGM_Explosives_fnc_SetupExplosive;closeDialog 0;", _mag]];
