...
closeDialog 0;
createDialog "BWA3_CommyRose_Dialog";

disableSerialization;
_dlgMenuDialog = uiNamespace getVariable "BWA3_Menu_Dialog";
...
for "_a" from 0 to (_countSubitems - 1) do {
  ...
  BWA3_Menu_Button set [_a, _menuSubitem select 1];
  uiNamespace setVariable ["BWA3_Menu_Control_" + str(_a), _ctrlMenuDialogX];
};