  ...
  class CAManBase: Man {
    ...
    class AGM_SelfActions {
      class AGM_Medical {
        ...
        class AGM_Bandage {
          displayName = "$STR_AGM_Medical_Bandage";
          condition = "AGM_Medical_SingleBandage > 0 (player getVariable 'AGM_CanTreat') and (player getVariable 'AGM_Treatable') and vehicle player == player and 'AGM_Bandage' in itemsWithMagazines player and (damage player > 0.01)";
