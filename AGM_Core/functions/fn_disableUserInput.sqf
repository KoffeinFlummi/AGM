...
if (_state) then {
  ...
  _dlg displayAddEventHandler ["KeyDown", {
    ...
    if (serverCommandAvailable "#missions" || {player getVariable ["AGM_isUnconscious", false] && {missionNamespace getVariable ["AGM_Medical_AllowChatWhileUnconscious", 0] > 0}})  then {
