/*
Name: AGM_Core_fnc_getForceWalkStatus
...
Example:
  [AGM_Player] call AGM_Core_fnc_getForceWalkStatus
*/
...
_unitForceWalkStatus = [_unitForceWalkNumber, count _forceWalkReasons] call AGM_Core_fnc_binarizeNumber;
