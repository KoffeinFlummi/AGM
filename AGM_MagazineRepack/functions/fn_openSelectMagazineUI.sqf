...
private ["_magazines", "_ammoTotal", "_listIDC", "_count", "_index", "_magazine", "_ammo", "_displayName", "_picture"];

_magazines = _this select 0;
_ammoTotal = _this select 1;
