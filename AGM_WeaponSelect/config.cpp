...
class AGM_Core_Default_Keys {
	class AGM_WeaponSelect {
		displayName = "AGM Weapon Select";
		class selectPistol {
			displayName = "$STR_AGM_WeaponSelect_SelectPistol";
			condition = "player == _vehicle && {['AGM_WeaponSelect', 'enableQuickSelect'] call AGM_Core_fnc_getOption} && {player getVariable ['AGM_CanTreat', true]}";
		...
		class engineOn {
			...
			condition = "player != _vehicle && {['AGM_WeaponSelect', 'enableQuickSelect'] call AGM_Core_fnc_getOption} && {player == driver _vehicle} && {!isEngineOn _vehicle}";
		...
		class selectMaingun {
			...
			condition = "player != _vehicle && {['AGM_WeaponSelect', 'enableQuickSelect'] call AGM_Core_fnc_getOption}";
