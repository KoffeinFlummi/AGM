...
_this spawn {
  ...
  _actionID = _unit addAction [format ["<t color='#FF0000'>%1</t>", localize "STR_AGM_Drag_EndDrag"], "AGM_player call AGM_Drag_fnc_releaseObject;", nil, 20, false, true, "","AGM_player call AGM_Drag_fnc_isDraggingObject"];
