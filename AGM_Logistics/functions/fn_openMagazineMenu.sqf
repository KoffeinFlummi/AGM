...
_magazines = [AGM_player, AGM_Logistics_targetVehicle] call AGM_Logistics_fnc_getLoadableMagazines;
...
[
  _actions,
  {
    ...
    [AGM_player, AGM_Logistics_targetVehicle, _this] call AGM_Logistics_fnc_loadMagazine;
  },
