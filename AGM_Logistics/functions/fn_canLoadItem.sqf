...
_nearestVehicles = [
  getPos AGM_player nearestObject "Car",
  getPos AGM_player nearestObject "Tank",
  getPos AGM_player nearestObject "Helicopter",
  getPos AGM_player nearestObject "Plane",
  getPos AGM_player nearestObject "Ship"
];

_distances = [];
{
  if (typeName _x == "OBJECT") then {
    _distances pushBack (AGM_player distance _x);
  };
