...
private ["_idc", "_selectedIndex", "_wasDoubleClick", "_settingDoubleClick", "_player", "_lbDataString", "_foundClass", "_class", "_itemsInContainer", "_uniqueWeaponsArray", "_uniqueItemsArray", "_item", "_mouseUpEvent", "_mousePos"];
