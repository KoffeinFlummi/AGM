...
private ["_idc", "_mouseButton", "_mousePos", "_baseClassName", "_wasDoubleClick", "_settingDoubleClick", "_searchArray", "_classNamesArray", "_configPath", "_baseClassname", "_clickedClassName"];
...
_searchArray = switch (_idc) do {//[array of possible classnames, config path, base classname]
